 ...
 * @author  Naoghuman
 */
public class DemoWithoutCssFileController extends FXMLController {
    ...
    public void initialize(final URL location, final ResourceBundle resources) {
        LoggerFacade.getDefault().info(this.getClass(), "DemoWithoutCssFileController#initialize(URL, ResourceBundle)"); // NOI18N
    ...
    private String initializeDemoInfos() {
        LoggerFacade.getDefault().info(this.getClass(), "DemoWithoutCssFileController#initializeDemoInfos()"); // NOI18N
    ...
    public void configure(final FXMLModel model) {
        LoggerFacade.getDefault().debug(this.getClass(), "DemoWithoutCssFileController#configure(FXMLModel)"); // NOI18N
    ...
    public void onActionShowFXMLViewInfos(final String fxmlViewInfos) {
        LoggerFacade.getDefault().debug(this.getClass(), "DemoWithoutCssFileController#onActionShowFXMLViewInfos(String)"); // NOI18N
